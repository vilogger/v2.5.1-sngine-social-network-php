...
(1, 'vi_vn', 'VietNamese', 'vn', 'LTR', '1', '1'),
(2, 'en_us', 'English', 'us', 'LTR', '0', '1'),
(3, 'ar_sa', 'Arabic', 'sa', 'RTL', '0', '1'),
(4, 'fr_fr', 'Fran&ccedil;ais', 'fr', 'LTR', '0', '1'),
(5, 'es_es', 'Espa&ntilde;ol', 'es', 'LTR', '0', '1'),
(6, 'pt_pt', 'Portugu&ecirc;s', 'pt', 'LTR', '0', '1'),
(7, 'de_de', 'Deutsch', 'de', 'LTR', '0', '1'),
(8, 'tr_tr', 'T&uuml;rk&ccedil;e', 'tr', 'LTR', '0', '1'),
(9, 'nl_nl', 'Dutch', 'nl', 'LTR', '0', '1'),
(10, 'it_it', 'Italiano', 'it', 'LTR', '0', '1'),
(11, 'ru_ru', 'Russian', 'ru', 'LTR', '0', '1'),
(12, 'ro_ro', 'Romaian', 'ro', 'LTR', '0', '1');
...
ALTER TABLE `widgets`
  MODIFY `widget_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
    ...
    * config
    * @package Sngine
    * @Việt hóa bởi: thaibinhvip
    * @Site: https://nam.name.vn  
    */ 
